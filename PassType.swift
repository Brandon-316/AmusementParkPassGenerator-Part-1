...
class Entrant: Name, Address, BirthDate {
    ...
    init(firstName: String, lastName: String, street: String, city: String, state: String, zip: String, monthOfBirth: Int, dayOfBirth: Int, yearOfBirth: Int, entrantType: EntrantPassType) {
